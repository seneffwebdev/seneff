$(document).ready(function () {
  ...
  var Nexus = {
    ...
    mainNavAnimated:
      document.querySelector("[data-menuAnimated]").dataset.menuanimated ===
      "true"
        ? true
        : false,
    ...
    validateForm: function () {
      ...
      Array.from(
        document.querySelectorAll(".js-form-validation .c-form__field")
    ...
    tabsPublications: function () {
      $("#publications .c-article__item").hide()
    ...
    toggleMainNav: function () {
      this.globalArgs.mainNavList.classList.toggle(
        "c-main-nav__list--is-visible"
      );
      this.globalArgs.mainNavToggle.classList.toggle(
        "c-main-nav__bars--is-toggled"
      );
    },
